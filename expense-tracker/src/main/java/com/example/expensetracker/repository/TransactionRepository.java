...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    List<Transaction> findByOccurredOnBetweenAndCategory_IdOrderByOccurredOnDesc(
            LocalDate start, LocalDate end, Long categoryId);
    ...
    @Query("SELECT SUM(t.amount) FROM Transaction t " +
           "WHERE t.occurredOn BETWEEN :start AND :end " +
